...
function hashPassword(password, callback) {
    ...
    crypto.randomBytes(config.saltBytes, function(err, salt) {
        ...
        crypto.pbkdf2(password, salt, config.iterations, config.hashBytes,'sha512',
            function(err, hash) {
 ...
 */
function verifyPassword(password, combinedStr, callback) {
    // extract the salt and hash from the combined buffer
    var combined = Buffer.from(combinedStr, config.encoding);
